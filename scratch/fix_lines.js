...
for (let i = 0; i < lines.length; i++) {
  if (lines[i].includes('// ─── BULK SEARCH PAGE ─────────────────────────────────────────────────────────')) {
    startIdx = i;
  }
  if (startIdx !== -1 && i > startIdx && lines[i].includes('// ─── GENERATOR PAGE ────────────────────────────────────────────────────────────')) {
    endIdx = i;
    break;
  }
}
...
if (startIdx !== -1 && endIdx !== -1) {
  const replacement = `    // ─── BULK SEARCH PAGE ─────────────────────────────────────────────────────────
  ...
  console.log("Could not find blocks", startIdx, endIdx);
}
